...
// ../.wrangler/tmp/bundle-IHIQhQ/checked-fetch.js
...
var onRequestDelete7 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
  if (request.headers.get("x-admin-key") !== ADMIN_KEY7) return unauthorized7();
  try {
...
// ../.wrangler/tmp/pages-DX0yuU/functionsRoutes-0.43383948904389913.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-IHIQhQ/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-IHIQhQ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8230581688851478.mjs.map
