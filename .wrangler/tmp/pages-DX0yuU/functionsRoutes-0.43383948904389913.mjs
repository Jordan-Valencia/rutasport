...
import { onRequestDelete as __api_admin_teams__id__ts_onRequestDelete } from "C:\\Users\\Jordan\\Desktop\\trabajos\\RutaSport\\functions\\api\\admin\\teams\\[id].ts"
import { onRequestPut as __api_admin_teams__id__ts_onRequestPut } from "C:\\Users\\Jordan\\Desktop\\trabajos\\RutaSport\\functions\\api\\admin\\teams\\[id].ts"
...
import { onRequestGet as __api_admin_teams_ts_onRequestGet } from "C:\\Users\\Jordan\\Desktop\\trabajos\\RutaSport\\functions\\api\\admin\\teams.ts"
import { onRequestPost as __api_admin_teams_ts_onRequestPost } from "C:\\Users\\Jordan\\Desktop\\trabajos\\RutaSport\\functions\\api\\admin\\teams.ts"
...
import { onRequestGet as __api_teams_ts_onRequestGet } from "C:\\Users\\Jordan\\Desktop\\trabajos\\RutaSport\\functions\\api\\teams.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "DELETE",
      middlewares: [],
      modules: [__api_admin_teams__id__ts_onRequestDelete],
    },
  {
      routePath: "/api/admin/teams/:id",
      mountPath: "/api/admin/teams",
      method: "PUT",
      middlewares: [],
      modules: [__api_admin_teams__id__ts_onRequestPut],
    },
  {
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_admin_teams_ts_onRequestGet],
    },
  {
      routePath: "/api/admin/teams",
      mountPath: "/api/admin",
      method: "POST",
      middlewares: [],
      modules: [__api_admin_teams_ts_onRequestPost],
    },
  {
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_teams_ts_onRequestGet],
    },
  {
