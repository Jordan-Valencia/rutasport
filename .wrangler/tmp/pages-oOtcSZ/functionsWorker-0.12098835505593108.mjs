...
// ../.wrangler/tmp/bundle-dLMxdO/checked-fetch.js
...
var init_id = __esm({
  "api/admin/banners/[id].ts"() {
    init_functionsRoutes_0_711471241525402();
    init_checked_fetch();
    ...
    onRequestPut = /* @__PURE__ */ __name(async ({ env, request, params }) => {
    ...
    onRequestDelete = /* @__PURE__ */ __name(async ({ env, request, params }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY) return unauthorized();
      try {
...
var init_id2 = __esm({
  "api/admin/brands/[id].ts"() {
    ...
    onRequestPut2 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
    ...
    onRequestDelete2 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY2) return unauthorized2();
      try {
...
var init_id3 = __esm({
  "api/admin/categories/[id].ts"() {
    ...
    onRequestPut3 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
    ...
    onRequestDelete3 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY3) return unauthorized3();
      try {
...
var init_id4 = __esm({
  "api/admin/heroes/[id].ts"() {
    ...
    onRequestPut4 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
    ...
    onRequestDelete4 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY4) return unauthorized4();
      try {
...
var init_id5 = __esm({
  "api/admin/inventory/[id].ts"() {
    ...
    onRequestGet = /* @__PURE__ */ __name(async ({ env, request, params }) => {
    ...
    onRequestPut5 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY5) return unauthorized5();
      try {
        const b = await request.json();
        ...
        await env.DB.prepare("UPDATE product_inventory SET stock = ? WHERE product_id = ? AND size = ?").bind(b.stock, params.id, b.size).run();
...
var init_id6 = __esm({
  "api/admin/orders/[id].ts"() {
    ...
    onRequestPut6 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY6) return unauthorized6();
      try {
        const id = Number(params["id"]);
        if (!id) return json6({ error: "ID inv\xE1lido" }, 400);
        const body = await request.json();
        const current = await env.DB.prepare("SELECT id, shipping_status, tracking_number, shipping_notes FROM orders WHERE id = ?").bind(id).first();
...
var init_id7 = __esm({
  "api/admin/products/[id].ts"() {
    ...
    onRequestPut7 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
      ...
      try {
       ...
       WHERE id=?`
        ...
        const existingInv = await env.DB.prepare("SELECT size FROM product_inventory WHERE product_id = ?").bind(params.id).all();
    ...
    onRequestDelete5 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY7) return unauthorized7();
      try {
        await env.DB.prepare("DELETE FROM product_categories WHERE product_id = ?").bind(params.id).run();
        await env.DB.prepare("DELETE FROM product_sports WHERE product_id = ?").bind(params.id).run();
...
var init_id8 = __esm({
  "api/admin/sports/[id].ts"() {
    ...
    onRequestPut8 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
    ...
    onRequestDelete6 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY8) return unauthorized8();
      try {
...
var init_id9 = __esm({
  "api/admin/users/[id].ts"() {
    ...
    onRequestPut9 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY9) return unauthorized9();
      try {
        const id = Number(params["id"]);
        if (!id) return json9({ error: "ID inv\xE1lido" }, 400);
        const body = await request.json();
        const current = await env.DB.prepare("SELECT id, email, full_name, phone, address FROM users WHERE id = ?").bind(id).first();
        if (!current) return json9({ error: "Usuario no encontrado" }, 404);
        const newEmail = body.email?.trim() || current.email;
        if (newEmail !== current.email) {
          const conflict = await env.DB.prepare("SELECT id FROM users WHERE email = ? AND id != ?").bind(newEmail, id).first();
...
var ADMIN_KEY10, json10, unauthorized10, onRequestGet2;
var init_analytics = __esm({
  "api/admin/analytics.ts"() {
    ...
    onRequestGet2 = /* @__PURE__ */ __name(async ({ env, request }) => {
...
var ADMIN_KEY11, json11, unauthorized11, onRequestGet3, onRequestPost;
var init_banners = __esm({
  "api/admin/banners.ts"() {
    ...
    onRequestGet3 = /* @__PURE__ */ __name(async ({ env, request }) => {
...
// api/admin/brands.ts
var ADMIN_KEY12, json12, unauthorized12, onRequestGet4, onRequestPost2;
...
var ADMIN_KEY13, json13, unauthorized13, onRequestGet5, onRequestPost3;
var init_categories = __esm({
  "api/admin/categories.ts"() {
    ...
    onRequestPost3 = /* @__PURE__ */ __name(async ({ env, request }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY13) return unauthorized13();
      try {
        const b = await request.json();
...
var ADMIN_KEY14, json14, unauthorized14, onRequestGet6;
...
// api/admin/heroes.ts
var ADMIN_KEY15, json15, unauthorized15, onRequestGet7, onRequestPost4;
...
// api/admin/orders.ts
var ADMIN_KEY16, json16, unauthorized16, onRequestGet8;
  ...
  "api/admin/orders.ts"() {
    ...
    onRequestGet8 = /* @__PURE__ */ __name(async ({ env, request }) => {
      ...
      try {
        ...
        LIMIT 500
      `).all();
        if (!orders.results.length) return json16([]);
        const ids = orders.results.map((o) => o.id);
        const placeholders = ids.map(() => "?").join(",");
        const items = await env.DB.prepare(`SELECT * FROM order_items WHERE order_id IN (${placeholders})`).bind(...ids).all();
        const byOrder = {};
        for (const item of items.results) {
          if (!byOrder[item.order_id]) byOrder[item.order_id] = [];
          byOrder[item.order_id].push(item);
        }
        return json16(orders.results.map((o) => ({ ...o, items: byOrder[o.id] ?? [] })));
      } catch (e) {
...
var ADMIN_KEY17, json17, unauthorized17, PRODUCT_SELECT, onRequestGet9, onRequestPost5;
...
`;
    ...
    onRequestPost5 = /* @__PURE__ */ __name(async ({ env, request }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY17) return unauthorized17();
      try {
        const b = await request.json();
        const price = Number(b.price);
...
// api/admin/sports.ts
var ADMIN_KEY18, json18, unauthorized18, onRequestGet10, onRequestPost6;
var init_sports = __esm({
  "api/admin/sports.ts"() {
    ...
    onRequestPost6 = /* @__PURE__ */ __name(async ({ env, request }) => {
      if (request.headers.get("x-admin-key") !== ADMIN_KEY18) return unauthorized18();
      try {
        const b = await request.json();
        if (!b.name) {
...
// api/admin/upload.ts
var ADMIN_KEY19, json19, unauthorized19, onRequestPost7, onRequestGet11, onRequestDelete7;
var init_upload = __esm({
  "api/admin/upload.ts"() {
    ...
    onRequestPost7 = /* @__PURE__ */ __name(async ({ env, request }) => {
...
var ADMIN_KEY20, json20, unauthorized20, EXT_TO_MIME, onRequestPost8;
var init_upload_url = __esm({
  "api/admin/upload-url.ts"() {
    ...
    onRequestPost8 = /* @__PURE__ */ __name(async ({ env, request }) => {
...
// api/admin/users.ts
var ADMIN_KEY21, json21, unauthorized21, onRequestGet12;
...
// api/admin/videos.ts
var ADMIN_KEY22, json22, unauthorized22, onRequestPost9, onRequestGet13, onRequestDelete8;
var init_videos = __esm({
  "api/admin/videos.ts"() {
    ...
    onRequestPost9 = /* @__PURE__ */ __name(async ({ env, request }) => {
...
var onRequestOptions, onRequestPost10;
var init_pageview = __esm({
  "api/analytics/pageview.ts"() {
    init_functionsRoutes_0_711471241525402();
    init_checked_fetch();
    onRequestOptions = /* @__PURE__ */ __name(async () => new Response(null, {
      headers: {
    ...
    onRequestPost10 = /* @__PURE__ */ __name(async ({ env, request }) => {
      try {
        const body = await request.json();
...
var init_login = __esm({
  "api/auth/login.ts"() {
    ...
    init_checked_fetch();
    init_helpers();
    onRequestOptions2 = /* @__PURE__ */ __name(async () => CORS_OPTIONS, "onRequestOptions");
    onRequestPost11 = /* @__PURE__ */ __name(async ({ env, request }) => {
      try {
        const body = await request.json();
        const email = body.email?.trim().toLowerCase();
        const password = body.password?.trim();
        if (!email || !password) return jsonErr("Email y contrase\xF1a son requeridos");
        const row = await env.DB.prepare("SELECT id, email, password_hash, full_name, phone, address, createdAt FROM users WHERE email = ?").bind(email).first();
        ...
        await env.DB.prepare("INSERT INTO user_sessions (user_id, token, expires_at) VALUES (?, ?, ?)").bind(row.id, token, expiresAt).run();
...
// api/auth/me.ts
var onRequestOptions4, onRequestGet14;
var init_me = __esm({
  "api/auth/me.ts"() {
    init_functionsRoutes_0_711471241525402();
    init_checked_fetch();
    onRequestOptions4 = /* @__PURE__ */ __name(async () => new Response(null, {
      headers: {
        "Access-Control-Allow-Origin": "*",
    ...
    onRequestGet14 = /* @__PURE__ */ __name(async ({ env, request }) => {
      try {
        ...
        const user = await getAuthenticatedUser2(request, env.DB);
        if (!user) {
...
// api/auth/orders.ts
var onRequestOptions5, onRequestGet15;
...
var onRequestOptions6, onRequestPut10;
var init_password = __esm({
  "api/auth/password.ts"() {
    init_functionsRoutes_0_711471241525402();
    init_checked_fetch();
    init_helpers();
    onRequestOptions6 = /* @__PURE__ */ __name(async () => CORS_OPTIONS, "onRequestOptions");
    onRequestPut10 = /* @__PURE__ */ __name(async ({ env, request }) => {
      try {
        const user = await getAuthenticatedUser(request, env.DB);
        if (!user) return jsonErr("No autenticado", 401);
        const body = await request.json();
...
// api/auth/profile.ts
var onRequestOptions7, onRequestGet16, onRequestPut11;
var init_profile = __esm({
  "api/auth/profile.ts"() {
    ...
    onRequestPut11 = /* @__PURE__ */ __name(async ({ env, request }) => {
      try {
        const user = await getAuthenticatedUser(request, env.DB);
        if (!user) return jsonErr("No autenticado", 401);
        const body = await request.json();
        ...
        if (newEmail && newEmail !== user.email) {
          const taken = await env.DB.prepare("SELECT id FROM users WHERE email = ? AND id != ?").bind(newEmail, user.id).first();
...
var onRequestOptions8, onRequestPost13;
var init_register = __esm({
  "api/auth/register.ts"() {
    ...
    onRequestPost13 = /* @__PURE__ */ __name(async ({ env, request }) => {
      try {
        const body = await request.json();
        const email = body.email?.trim().toLowerCase();
        const password = body.password?.trim();
      ...
      `).bind(email, password_hash, full_name, phone, region, city, address).first();
        ...
        const token = generateToken();
        const expiresAt = new Date(Date.now() + 30 * 24 * 60 * 60 * 1e3).toISOString();
        await env.DB.prepare("INSERT INTO user_sessions (user_id, token, expires_at) VALUES (?, ?, ?)").bind(user.id, token, expiresAt).run();
        return new Response(JSON.stringify({ token, user }), {
          status: 201,
          headers: {
            ...JSON_HEADERS,
...
var headers, onRequestOptions9, onRequestGet17;
var init_transaction = __esm({
  "api/epayco/transaction.ts"() {
    ...
    onRequestOptions9 = /* @__PURE__ */ __name(async () => new Response(null, {
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Access-Control-Allow-Methods": "GET, OPTIONS",
        "Access-Control-Allow-Headers": "Content-Type"
...
function getEpaycoService2(env) {
  return new EpaycoService({
    publicKey: env.EPAYCO_PUBLIC_KEY,
    privateKey: env.EPAYCO_PRIVATE_KEY,
    customerId: env.EPAYCO_CUSTOMER_ID,
...
var init_webhook = __esm({
  "api/epayco/webhook.ts"() {
    ...
    onRequestPost14 = /* @__PURE__ */ __name(async ({ env, request }) => {
      try {
        const epayco = getEpaycoService2(env);
        ...
        const order = await env.DB.prepare("SELECT id, status, total_in_cents FROM orders WHERE reference = ?").bind(reference).first();
        if (!order) {
        ...
        if (status === "APPROVED") {
          const items = await env.DB.prepare("SELECT product_id, size, quantity FROM order_items WHERE order_id = ?").bind(order.id).all();
          for (const item of items.results) {
            if (!item.size) continue;
            const rawSize = item.size.replace(/^US/i, "");
            await env.DB.prepare("UPDATE product_inventory SET stock = stock - ? WHERE product_id = ? AND size = ? AND stock >= ?").bind(item.quantity, item.product_id, rawSize, item.quantity).run();
          }
        }
        await env.DB.prepare("UPDATE orders SET status = ?, epayco_refpayco = ? WHERE reference = ?").bind(status, refPayco, reference).run();
        return new Response("OK", { status: 200 });
      } catch (e) {
...
var init_id10 = __esm({
  ...
  GROUP BY p.id
`;
    onRequestGet18 = /* @__PURE__ */ __name(async ({ env, params }) => {
      try {
        const id = params.id;
        if (!id || isNaN(+id)) {
...
// api/banners.ts
var corsHeaders, onRequestGet19;
...
// api/categories.ts
var corsHeaders3, onRequestGet21;
...
// api/genders.ts
var corsHeaders4, onRequestGet22;
...
// api/heroes.ts
var corsHeaders5, onRequestGet23;
...
// api/orders.ts
function getEpaycoService3(env) {
  return new EpaycoService({
    publicKey: env.EPAYCO_PUBLIC_KEY,
    privateKey: env.EPAYCO_PRIVATE_KEY,
    customerId: env.EPAYCO_CUSTOMER_ID,
...
var headers2, onRequestOptions10, onRequestPost15;
var init_orders3 = __esm({
  "api/orders.ts"() {
    ...
    onRequestOptions10 = /* @__PURE__ */ __name(async () => new Response(null, {
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Access-Control-Allow-Methods": "POST, OPTIONS",
        "Access-Control-Allow-Headers": "Content-Type, Authorization"
    ...
    onRequestPost15 = /* @__PURE__ */ __name(async ({ env, request }) => {
      try {
        ...
        if (token) {
          const session2 = await env.DB.prepare(`SELECT user_id FROM user_sessions WHERE token = ? AND datetime(expires_at) > datetime('now')`).bind(token).first();
        ...
        const order = await env.DB.prepare(`INSERT INTO orders (reference, status, total_in_cents, user_id) VALUES (?, 'RESERVED', ?, ?) RETURNING id`).bind(reference, totalCOP, userId).first();
        ...
        const epayco = getEpaycoService3(env);
...
// api/sports.ts
var corsHeaders6, onRequestGet25;
...
var init_path = __esm({
  "images/[[path]].ts"() {
    ...
    onRequestGet26 = /* @__PURE__ */ __name(async ({ env, params }) => {
      try {
...
var init_path2 = __esm({
  "videos/[[path]].ts"() {
    ...
    onRequestGet27 = /* @__PURE__ */ __name(async ({ env, params, request }) => {
      try {
        const parts = Array.isArray(params.path) ? params.path : [params.path];
        const key = "videos/" + parts.join("/");
        const rangeHeader = request.headers.get("range");
        const obj = rangeHeader ? await env.IMAGES.get(key, { range: request.headers }) : await env.IMAGES.get(key);
        if (!obj) return new Response("Not found", { status: 404 });
        const headers4 = new Headers();
        obj.writeHttpMetadata(headers4);
        if (!headers4.get("content-type")) {
...
// ../.wrangler/tmp/pages-oOtcSZ/functionsRoutes-0.711471241525402.mjs
var routes;
var init_functionsRoutes_0_711471241525402 = __esm({
  "../.wrangler/tmp/pages-oOtcSZ/functionsRoutes-0.711471241525402.mjs"() {
    "use strict";
    init_id();
    init_id();
...
// ../.wrangler/tmp/bundle-dLMxdO/middleware-loader.entry.ts
init_functionsRoutes_0_711471241525402();
init_checked_fetch();

// ../.wrangler/tmp/bundle-dLMxdO/middleware-insertion-facade.js
init_functionsRoutes_0_711471241525402();
init_checked_fetch();
...
//# sourceMappingURL=functionsWorker-0.12098835505593108.mjs.map
