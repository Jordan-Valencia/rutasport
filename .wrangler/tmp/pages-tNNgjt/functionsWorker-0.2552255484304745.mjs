...
// ../.wrangler/tmp/bundle-f1sQWg/checked-fetch.js
...
var onRequestDelete6 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
  if (request.headers.get("x-admin-key") !== ADMIN_KEY6) return unauthorized6();
  try {
    await env.DB.prepare("UPDATE products SET sport_id = NULL WHERE sport_id = ?").bind(params.id).run();
...
var onRequestGet15 = /* @__PURE__ */ __name(async ({ env }) => {
  try {
    const result = await env.DB.prepare(
...
// ../.wrangler/tmp/pages-tNNgjt/functionsRoutes-0.7885478821130438.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-f1sQWg/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-f1sQWg/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2552255484304745.mjs.map
