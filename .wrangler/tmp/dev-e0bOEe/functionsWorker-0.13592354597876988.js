...
// .wrangler/tmp/bundle-y6frnp/checked-fetch.js
...
// .wrangler/tmp/pages-w1uDFH/functionsWorker-0.13592354597876988.mjs
...
var onRequestGet8 = /* @__PURE__ */ __name2(async ({ env, request }) => {
  ...
  try {
    ...
    return json14({ items, nextCursor: list.truncated ? list.cursor : null, hasMore: list.truncated });
  } catch (e) {
    return json14({ error: e.message ?? "Internal error" }, 500);
  }
}, "onRequestGet");
...
var QUERY = `
  ...
  GROUP BY p.id
`;
var onRequestGet9 = /* @__PURE__ */ __name2(async ({ env, params }) => {
  try {
    const id = params.id;
    if (!id || isNaN(+id)) {
...
var onRequestGet16 = /* @__PURE__ */ __name2(async ({ env }) => {
  try {
    const result = await env.DB.prepare(
...
// .wrangler/tmp/bundle-y6frnp/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-y6frnp/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.13592354597876988.js.map
