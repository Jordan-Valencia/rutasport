...
// .wrangler/tmp/bundle-NAM5AN/checked-fetch.js
...
// .wrangler/tmp/pages-NCyIcm/functionsWorker-0.3953573655578331.mjs
...
var onRequestPost4 = /* @__PURE__ */ __name2(async ({ env, request }) => {
  ...
  try {
    const b = await request.json();
    if (!b.campaignName || !b.category || !b.imageUrl) {
      return json11({ error: "Missing required fields: campaignName, category, imageUrl" }, 400);
    }
    const result = await env.DB.prepare(
...
var PRODUCT_SELECT = `
  SELECT
    ...
    p.brand_id, p.category_id, p.sport_id, p.gender_id,
...
var onRequestPost7 = /* @__PURE__ */ __name2(async ({ env, request }) => {
  ...
  try {
    ...
    if (!file) return json14({ error: "No file provided" }, 400);
...
var onRequestGet9 = /* @__PURE__ */ __name2(async ({ env }) => {
  try {
    const result = await env.DB.prepare(
...
var onRequestGet14 = /* @__PURE__ */ __name2(async ({ env }) => {
  try {
    const result = await env.DB.prepare(
...
var onRequestGet15 = /* @__PURE__ */ __name2(async ({ env, params }) => {
  try {
...
// .wrangler/tmp/bundle-NAM5AN/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-NAM5AN/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3953573655578331.js.map
