...
// ../.wrangler/tmp/bundle-FagMvm/checked-fetch.js
...
var json22 = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data), { status, headers: { "Content-Type": "application/json" } }), "json");
var unauthorized22 = /* @__PURE__ */ __name(() => json22({ error: "Unauthorized" }, 401), "unauthorized");
...
var QUERY = `
  ...
  GROUP BY p.id
`;
var onRequestGet18 = /* @__PURE__ */ __name(async ({ env, params }) => {
  try {
    const id = params.id;
    if (!id || isNaN(+id)) {
...
var onRequestGet23 = /* @__PURE__ */ __name(async ({ env }) => {
  try {
    const result = await env.DB.prepare(
...
var onRequestGet26 = /* @__PURE__ */ __name(async ({ env, params }) => {
  try {
...
var onRequestGet27 = /* @__PURE__ */ __name(async ({ env, params, request }) => {
  try {
...
// ../.wrangler/tmp/pages-AL6krv/functionsRoutes-0.7279749859185258.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-FagMvm/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-FagMvm/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.47320182372968533.mjs.map
