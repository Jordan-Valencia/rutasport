...
CREATE TABLE `__new_feature_banners` (
	...
	`createdAt` text DEFAULT '2026-04-22T11:32:14.086Z'
);
--> statement-breakpoint
...
CREATE TABLE `__new_products` (
	...
	`description` text,
	`sizes` text,
	`createdAt` text DEFAULT '2026-04-22T11:32:14.085Z'
);
--> statement-breakpoint
INSERT INTO `__new_products`("id", "name", "price", "brand_id", "gender_id", "image", "isBestSeller", "isNew", "description", "sizes", "createdAt") SELECT "id", "name", "price", "brand_id", "gender_id", "image", "isBestSeller", "isNew", "description", "sizes", "createdAt" FROM `products`;--> statement-breakpoint
