...
CREATE TABLE `__new_feature_banners` (
	...
	`createdAt` text DEFAULT '2026-04-19T01:59:13.235Z'
);
...
CREATE TABLE `__new_products` (
	...
	`description` text,
	`sizes` text,
	`createdAt` text DEFAULT '2026-04-19T01:59:13.234Z'
);
--> statement-breakpoint
INSERT INTO `__new_products`("id", "name", "price", "brand_id", "category_id", "sport_id", "gender_id", "image", "isBestSeller", "isNew", "description", "sizes", "createdAt") SELECT "id", "name", "price", "brand_id", "category_id", "sport_id", "gender_id", "image", "isBestSeller", "isNew", "description", "sizes", "createdAt" FROM `products`;--> statement-breakpoint
